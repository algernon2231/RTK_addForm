...
const Navbar = () => {
    ...
    return (
        <div className='absolute w-full flex justify-between p-4 items-center '>
            ...
            <HiMenuAlt3 size={25} onClick={handleNav} className="z-20 text-white cursor-pointer" />
            <div className={
                nav ? 'ease-in duration-300  fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 px-4 py-7 flex-col z-10 '
                    :
                    'absolute top-0 h-screen left-[-100%] ease-in duration-500 z-10'
            }>
                <ul className='flex flex-col fixed w-full h-full items-center justify-center font-roboto'>
                    <li className='font-bold text-3xl p-8'>Home</li>
                    <li className='font-bold text-3xl p-8'>Destinations</li>
                    <li className='font-bold text-3xl p-8'>Revervations</li>
