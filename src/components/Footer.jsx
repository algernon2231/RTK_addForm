...
const Footer = () => {
    return (
        <div className='w-full mt-24 py-2 px-2 bg-gray-900 text-gray-300'>
            <div className='max-w-[1440px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4 '>
                ...
                <div className='col-span-2 py-8 md:pt-2'>
                    ...
                    <form action="" className='flex flex-col sm:flex-row'>
                        <input className='w-full p-2 mr-4 rounded-md mb-4' type="email" name="" id="" placeholder='Enter your email' />
